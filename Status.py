...
class Status():
    def __init__(self, status):
        ...
        self.added_status = {'HP': 0, 'MP': 0, 'Strength': 0, 'Skill': 0, 'Dexterity': 0, 'Intelligence': 0, 'Luck': 0, 'Defense': 0, 'Speed': 0, 'Concentration': 0, 'Reaction': 0, 'MP Regeneration': 0, 'HP Regeneration': 0}
        self.durable = list()
